...
export default function FinalCTA() {
  ...
  return (
    <section id="final-cta" className="py-24 px-4 relative overflow-hidden bg-[#030303]">
      {/* Background elements */}
      ...
      <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div 
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="bg-white/[0.03] backdrop-blur-sm border border-white/[0.08] rounded-xl p-8 max-w-xl mx-auto relative overflow-hidden group"
          >
